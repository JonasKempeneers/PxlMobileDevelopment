...
public class oldBookListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oldbook_list);
    ...
    private void getFoundBooks() {
        ...
        call.enqueue(new Callback<List<Book>>() {
            ...
            public void onFailure(Call<List<Book>> call, Throwable t) {
                Toast.makeText(oldBookListActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
    ...
    private void generateBookList(ArrayList<Book> bookArrayList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(oldBookListActivity.this);
